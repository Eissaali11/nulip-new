      ...
      <div className="relative">
        ...
        >
          <nav className="flex items-center justify-between backdrop-blur-xl bg-white/5 rounded-2xl p-3 border border-white/10">
            <div className="flex items-center gap-2">
              <img src={stockProLogo} alt="Stock Pro" className="h-14 w-14 rounded-full object-contain bg-gray-900/50 p-1" />
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <motion.img 
                src={stockProLogo} 
                alt="Stock Pro" 
                className="relative h-48 lg:h-56 w-48 lg:w-56 rounded-full object-contain bg-gray-900/50 p-3 mx-auto"
                animate={{
                  y: [0, -10, 0],
                }}
                transition={{
        ...
        <footer className="container mx-auto px-4 py-12 border-t border-white/10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <img src={stockProLogo} alt="Stock Pro" className="h-24 w-24 rounded-full object-contain bg-gray-900/50 p-2" />
